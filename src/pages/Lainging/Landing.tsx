    ...
    <>
      <div className={styles.root}>
        ...
        <div className={styles.section1}>
          <div className={styles.others}>
            ...
            <div className={styles.section1Content}>
              <div className={styles.pagetitle}>
                ...
                <p>
                  정보를 얻기 위해 찾은 뉴스기사, 블로그 등 길고 복잡한 내용이
                  한눈에 안 들어오시죠?
                  <br /> 이젠 어썸으로 간략하고 핵심적인 내용만 쏙쏙 뽑아
                  들려드릴게요
                </p>
              </div>
          ...
          <Lottie loop animationData={Shape1} className={styles.shape1} />
          <Lottie loop animationData={Shape2} className={styles.shape2} />
          <Lottie loop animationData={Shape3} className={styles.shape3} />
          <Lottie loop animationData={Shape4} className={styles.shape4} />
        </div>
        {/* section 2 */}
        <div className={styles.section2}>
          <div className={styles.article1}>
            <div className={styles.articleContent}>
              ...
              <img
                src={Arrow}
                alt="article1-arrow"
                className={styles.article1Arrow}
              />
          ...
          <div className={styles.article2}>
            <div className={styles.articleImg}>
              <Lottie loop animationData={MicAnim} className={styles.micAnim} />
              <Lottie
                loop
        ...
        <div className={styles.footer}>
          ...
          <p className={styles.footerTitle}>@ASSUM</p>
